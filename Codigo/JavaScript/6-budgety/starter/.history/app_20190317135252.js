...
var controladorUI = (function () {
    ...
    return {
        ...
        mostrarPresupuesto: function (objeto) {
            ...
            document.querySelector(DOMclasshtml.presupuestoEtiqueta).textContent = obj.presupuesto;
            document.querySelector(DOMclasshtml.ingresoEtiqueta).textContent = obj.totaling;
            document.querySelector(DOMclasshtml.gastoEtiqueta).textContent = obj.totalgast;
            document.querySelector(DOMclasshtml.porcentajeEtiqueta).textContent = obj.porcentajes;
