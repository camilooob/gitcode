...
var controladorPresupuesto = (function() {
  ...
  Expenses.prototype.calculoPorcentajes = function(totaling) {
    if (totaling > 0) {
  ...
  Expenses.prototype.tomarPorcentaje = function() {
  ...
  return {
    ...
    calculoPorcentajes: function() {
      data.todoslosItems.Gasto.forEach(function(actual) {
        actual.calculoPorcentajes();
      });
    },

    tomarPorcentaje: function() {
      var todosporce = data.todoslosItems.Gasto.map(function(actual) {
...
var controladorApp = (function(contPresupuesto, contUI) {
  ...
  var actualizacionPorcentajes = function() {
    ...
    controladorApp.calculoPorcentajes();

    // 02. Leer porcentajes de el controlador de presupuesto

    var porcentajes = controladorApp.tomarPorcentaje();
